...
if (mysqli_num_rows($topic_result) < 1) {
				...
				$display_block = "<P><em>No sponsor cureently.</em></p>";
} else {
        ...
        <div id="page">
                                ...
                                <nav class="navbar navbar-default">
                                    ...
                                    <div class="collapse navigation navbar-collapse navbar-ex1-collapse remove-space">
                                        <ul class="list-unstyled nav1 cl-effect-10">
                                            ...
                                            <li><a data-hover="forum"  class="forum.php"><span>FORUM</span></a></li>
                                            <li><a data-hover="donation"  class="active"><span>Donation</span></a></li>                                          
                                        </ul>
                                    </div>
                                </nav>
                            </div>
            ...
            <section class="image-head-wrapper">
                <div class="inner-wrapper">
                    <h1>Pastime Sports Donations</h1>
                </div>
            </section>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-7 about-right">
                            <h3>DONATION FORM</h3>
                            <p>Make an online donation to help our organization provide better services to our Members</p><br/>
                            <form action="donation.php" method="post">
                            <input type="text" class="form-control" name="fulname" placeholder="FullName" required="*"><br/>
                            <input type="email" class="form-control" name="email" placeholder="Email Address" required="*"><br/>
                            <label for="donation">Donation amount(£)</label>
                            <input type="text" class="form-control" name="amount" placeholder="£" required="*"><br/>
                            <label for="comment">Do you have anything to comment regarding your donation?</label>
                            <textarea class="form-control" name="don_comment" placeholder="Comment Here...." required=""></textarea>
                            <input type="submit" name="donate" class="submit-btn" value="DONATE">
                        </form>                                 
                        </div>
                    </div>
                    <div class="clearfix"> </div>
